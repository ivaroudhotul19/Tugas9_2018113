...
import com.example.recycleview.DrinkActivity;
import com.example.recycleview.R;

public class DrinkAdapter extends RecyclerView.Adapter<DrinkAdapter.DrinkViewHolder>{
    String data1[], data2[], data3[];
    int images[];
    DrinkActivity context;

    public DrinkAdapter(DrinkActivity ct, String[] s1, String[] s2, String[] s3, int[] img){
        context = ct;
        data1 = s1;
        data2 = s2;
        data3 = s3;
    ...
    public DrinkAdapter.DrinkViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.item_drink, parent, false);
